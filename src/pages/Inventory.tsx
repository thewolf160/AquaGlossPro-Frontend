      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 space-y-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex bg-gray-100 p-1 rounded-lg">
            ...
            <button 
              onClick={() => { setActiveFilter("CRITICOS"); setCurrentPage(1); }}
            ...
            <button 
              onClick={() => { setActiveFilter("AGOTADOS"); setCurrentPage(1); }}
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <button className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors flex items-center gap-2 whitespace-nowrap">
